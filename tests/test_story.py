...
def _year_of_days(station: str, year: int, value: float, *, days: int = 365) -> list[dict]:
    start = date(year, 1, 1)
    return [
        {
...
@pytest.fixture
def daily(monkeypatch):  # type: ignore[no-untyped-def]
...
class TestComparability:
    def test_a_year_with_thin_coverage_is_marked_not_dropped(self, daily) -> None:
    ...
    def test_coverage_uses_the_real_length_of_a_leap_year(self, daily) -> None:
    ...
    def test_an_incomparable_station_is_not_ranked(self, daily) -> None:
...
class TestExceedances:
    def test_counts_travel_with_their_denominator(self, daily) -> None:
    ...
    def test_the_who_threshold_is_stricter_than_taiwan_s(self, daily) -> None:
...
class TestBalancedPanel:
    ...
    def test_the_balanced_series_is_null_before_the_window_starts(self, daily) -> None:
    ...
    def test_the_panel_reports_which_stations_it_used(self, daily) -> None:
...
class TestStationCards:
    def test_a_closed_station_gets_the_card_for_its_last_good_year(self, daily) -> None:
    ...
    def test_the_cigarette_figure_ships_with_its_caveat(self, daily, tmp_path, monkeypatch) -> None:
    ...
    def test_a_station_with_no_comparable_year_yields_no_card(self, daily) -> None:
