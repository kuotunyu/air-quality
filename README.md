...
| 資訊來源 | 驗證樣本規模 | 留出檢驗改善率 (Held-out) | 中位預測效益<br/>(ΔRMSE · ΔR²) | 邊界與限制宣告 |
|---|---|---|---|---|
| **衛星遙測**<br/>(S5P + MAIAC) | 851 筆完整站月<br/>(76 測站 · 12 個月) | - 留出季度：3／4 fold<br/>- 留出測站：9／10 fold<br/>- 聯合轉移：37／40 fold<br/>(綜合改善：49／54) | ΔRMSE&nbsp;−0.588<br/>ΔR²&nbsp;+0.147 | 非因果 · 非衛星反演<br/>(校正與融合仍延後) |
| **ERA5 再分析**<br/>(BLH + 氣象) | 674,520 筆站時<br/>(77 測站 · 6 變數零缺失) | - 74 站共同：205／222 fold<br/>- 跨年同站：63／74 站<br/>- 跨年留站：70／74 站 | ΔRMSE&nbsp;−0.758<br/>ΔR²&nbsp;+0.249 | 尚未納入已發布 M4<br/>(正規化仍以站內為準) |
