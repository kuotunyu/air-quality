...
| Phase 6 | 衛星、ERA5 與微型感測器加值 | 🟡 S5P 與 MAIAC 來源取得 Stage A 已交付；2025 M8 關聯與 held-out predictive-value 診斷已交付；ERA5 2024–2025 robustness 已交付；微型感測器來源目錄 pilot 已完成，觀測 ZIP 尚未下載，校正與融合仍延後；不是因果、不是校正，也不是衛星推估 PM2.5 |
