...
### 台灣的 PM2.5 在 2008–2025 年間降了 60%；氣象標準化後的降幅比觀測值少 43%。
...
一個 candidate 的 candidate-minus-`station_mean` 配對 median station MAE delta 皆小於 0。此外，each
qualifying method must also have a
